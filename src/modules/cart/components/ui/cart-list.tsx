    ...
    return <>
        {
            cart.items != undefined && cart.items.length > 0
                ...
                : <div className="size-full max-w-sm mx-auto grid gap-4 p-6 relative content-center">
                    <svg viewBox="0 0 647.63626 632.17383">
                    ...
                    <Button asChild variant="outline" className="p-6 absolute top-1/2 left-1/2 -translate-1/2">
                        <NavLink to={`/carts/${cart.id}`}> Pilih Menu </NavLink>
                    </Button>
                </div>
        }
    </>
